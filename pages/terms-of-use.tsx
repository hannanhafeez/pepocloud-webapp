...
import section1Css from '@/styles/terms-of-use/section1.module.css'
import section2Css from '@/styles/terms-of-use/section2.module.css'
...
const TermsOfUse: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = ({}) => {
					...
					<div className={section2Css.section2_container}>
						...
						<div className={section2Css.data_container}>
							...
							<div>
								...
								<p>
									...
									on behalf of an entity (&quot;you&quot;) and Triniter Solutions LLP, doing business as trinitio.com 
									(&quot;<Bspan>trinitio.com</Bspan>&quot;, &quot;<Bspan>we</Bspan>&quot;, &quot;<Bspan>us</Bspan>&quot;, or &quot;<Bspan>our</Bspan>&quot;), concerning your access to and use of the trinitio.com 
									...
									the Site, you have read, understood, and agree to be bound by all of these Terms of Use. 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									and personal use only. Except as expressly provided in these Terms of Use, no part of the Site and 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									through automated or non-human means, whether through a bot, script or otherwise; (6) you will not use the Site 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								...
								<p>
									...
									you authorize us to charge your chosen payment provider for any such amounts upon making your 
								...
								<p>
									...
									requested or received payment. We also reserve the right to refuse any order placed through the Site.
								</p>
							</div>
						</div>
						...
						<div className={section2Css.data_container}>
							...
							<div>
								...
								<p>
									If you are unsatisfied with our services, please email us at support@trinitio.com or call us 
									at 5163363819.
								</p>
							</div>
						</div>
						...
						<div className={section2Css.data_container}>
							...
							<div>
								...
								<ul className='list-none'>
									...
									<li>
										3.  Except as may be the result of standard search engine or Internet browser usage, use, launch, develop, 
									...
									<li>
										5.  Copy or adapt the Site’s software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.
									</li>
									<li>
									...
									<li>
										8.  Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any portion of the 
										Site to you.
									</li>
									<li>
									...
									<li>
										10.  Decipher, decompile, disassemble, or reverse engineer any of the software comprising or in any way making up a 
										part of the Site.
									</li>
									<li>
									...
									<li>
										18.  Trick, defraud, or mislead us and other users, especially in any attempt to learn sensitive 
									...
									<li>
										20.  Circumvent, disable, or otherwise interfere with security-related features of the Site, including 
									...
									<li>
										24.  Systematically retrieve data or other content from the Site to create or compile, directly or 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									transmit may be treated in accordance with the Site Privacy Policy. When you create or make available 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									of Defense (&quot;DOD&quot;), our services are subject to the terms of these Terms of Use in accordance 
									with FAR 12.212 (for computer software) and FAR 12.211 (for technical data). If our services 
									are acquired by or on behalf of any agency within the Department of Defense, our services 
									are subject to the terms of these Terms of Use in accordance with Defense Federal Acquisition 
									Regulation (&quot;DFARS&quot;) 227.7202‑3. In addition, DFARS 252.227‑7015 applies to technical data 
									acquired by the DOD. This U.S. Government Rights clause is in lieu of, and supersedes, any 
									other FAR, DFARS, or other clause or provision that addresses government rights in computer 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									or these Terms of Use, including without limitation, reporting such user to law enforcement authorities; 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									<a>https://trinitio.com/privacy-policy</a>. By using the Site, you agree to be bound by 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									These Terms shall be governed by and defined following the laws of India. Triniter Solutions LLP 
									and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								...
								<p>
									...
									this clause. The number of arbitrators shall be three (3). The seat, or legal place, of arbitration shall 
									be Chennai, India. The language to be used in the arbitral proceedings shall be Tamil. The governing law 
									of the contract shall be the substantive law of India.
								</p>
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								<p>
									...
									these Terms of Use will not be construed against us by virtue of having drafted them. You hereby waive any 
									and all defenses you may have based on the electronic form of these Terms of Use and the lack of signing by 
						...
						<div className={section2Css.data_container}>
							...
							<div>
								...
								<p>
									<Bspan>Triniter Solutions LLP 99 3 A South Street Chatrapatti RAJAPALAYAM, Tamil Nadu 626102 India 
									Phone: 5163363819 support@trinitio.com</Bspan>
								</p>
							</div>
						</div>
